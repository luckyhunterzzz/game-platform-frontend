...
const API = '/api/v1/admin/heroes/tags';
const CATALOG_API = '/api/v1/admin/heroes/tags/catalog';
const GROUPS_API = '/api/v1/admin/heroes/role-groups';
...
export default function HeroTagsWorkspace() {
  ...
  const t = useMemo(
    () =>
      locale === 'RU'
        ? {
            sectionTitle: '\u041f\u043e\u0434\u0442\u0438\u043f\u044b \u0433\u0435\u0440\u043e\u044f',
            sectionSubtitle: '\u041f\u043e\u043b\u043d\u044b\u0439 CRUD \u0434\u043b\u044f \u043f\u043e\u0434\u0442\u0438\u043f\u043e\u0432 \u0433\u0435\u0440\u043e\u044f',
            create: '\u0421\u043e\u0437\u0434\u0430\u0442\u044c',
            createTitle: '\u0421\u043e\u0437\u0434\u0430\u0442\u044c \u043f\u043e\u0434\u0442\u0438\u043f \u0433\u0435\u0440\u043e\u044f',
            editTitle: '\u0418\u0437\u043c\u0435\u043d\u0438\u0442\u044c \u043f\u043e\u0434\u0442\u0438\u043f \u0433\u0435\u0440\u043e\u044f',
            detailsTitle: '\u0414\u0435\u0442\u0430\u043b\u0438 \u043f\u043e\u0434\u0442\u0438\u043f\u0430 \u0433\u0435\u0440\u043e\u044f',
            ...
            creating: '\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435...',
            saving: '\u0421\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0435...',
            loadingList: '\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u043f\u043e\u0434\u0442\u0438\u043f\u043e\u0432...',
            loadingDetails: '\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u0434\u0435\u0442\u0430\u043b\u0435\u0439...',
            empty: '\u041f\u043e\u0434\u0442\u0438\u043f\u043e\u0432 \u043f\u043e\u043a\u0430 \u043d\u0435\u0442',
            select: '\u0412\u044b\u0431\u0435\u0440\u0438 \u043f\u043e\u0434\u0442\u0438\u043f \u0438\u0437 \u0441\u043f\u0438\u0441\u043a\u0430',
            close: '\u0417\u0430\u043a\u0440\u044b\u0442\u044c',
            name: '\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435',
            ...
            searchPlaceholder: '\u041f\u043e\u0438\u0441\u043a \u043f\u043e\u0434\u0442\u0438\u043f\u043e\u0432',
            clearSearch: '\u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u043f\u043e\u0438\u0441\u043a',
            selectGroup: '\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u0438\u043f \u0433\u0435\u0440\u043e\u044f',
            searchGroup: '\u041f\u043e\u0438\u0441\u043a \u0442\u0438\u043f\u0430 \u0433\u0435\u0440\u043e\u044f',
            clearGroupSearch: '\u041e\u0447\u0438\u0441\u0442\u0438\u0442\u044c \u043f\u043e\u0438\u0441\u043a \u0442\u0438\u043f\u0430',
            noGroupFound: '\u0422\u0438\u043f \u0433\u0435\u0440\u043e\u044f \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d',
            groupRequired: '\u0422\u0438\u043f \u0433\u0435\u0440\u043e\u044f \u043e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u0435\u043d',
            deleteConfirm: (item: HeroTagItem) =>
              `\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043f\u043e\u0434\u0442\u0438\u043f #${item.id} (${item.name.ru})?`,
            nameRu: '\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 RU',
            nameEn: 'Name EN',
        ...
        : {
            sectionTitle: 'Hero Subtypes',
            sectionSubtitle: 'Full CRUD for hero subtypes',
            create: 'Create',
            createTitle: 'Create hero subtype',
            editTitle: 'Edit hero subtype',
            detailsTitle: 'Hero subtype details',
            ...
            creating: 'Creating...',
            saving: 'Saving...',
            loadingList: 'Loading hero subtypes...',
            loadingDetails: 'Loading details...',
            empty: 'No hero subtypes yet',
            select: 'Select a hero subtype from the list',
            close: 'Close',
            name: 'Name',
            ...
            loadMore: 'Load more',
            searchPlaceholder: 'Search hero subtypes',
            clearSearch: 'Clear search',
            selectGroup: 'Select hero type',
            searchGroup: 'Search hero type',
            clearGroupSearch: 'Clear hero type search',
            noGroupFound: 'No hero type found',
            groupRequired: 'Hero type is required',
            deleteConfirm: (item: HeroTagItem) => `Delete hero subtype #${item.id} (${item.name.en})?`,
            nameRu: 'Name RU',
            nameEn: 'Name EN',
  ...
  const [items, setItems] = useState<HeroTagItem[]>([]);
  const [groups, setGroups] = useState<HeroRoleGroupItem[]>([]);
  const [selectedId, setSelectedId] = useState<number | null>(null);
  const [selectedItem, setSelectedItem] = useState<HeroTagItem | null>(null);
  const [catalogPage, setCatalogPage] = useState<CatalogResponseDto<HeroTagResponseDto> | null>(null);
  ...
  const loadGroups = useCallback(async () => {
    const response = await apiJson<HeroRoleGroupResponseDto[]>(GROUPS_API);
    setGroups(response.map(mapHeroRoleGroupDto));
  }, [apiJson]);
  ...
  const loadList = useCallback(
    async (searchValue: string) => {
      ...
      try {
        ...
        const response = await apiJson<CatalogResponseDto<HeroTagResponseDto>>(`${CATALOG_API}?${params}`);
        const mapped = response.items.map(mapHeroTagDto);
        setItems(mapped);
        ...
        setListError(error instanceof Error ? error.message : 'Failed to load hero subtypes');
      } finally {
  ...
  const loadDetails = useCallback(
    async (id: number) => {
      ...
      try {
        const response = await apiJson<HeroTagResponseDto>(`${API}/${id}`);
        setSelectedItem(mapHeroTagDto(response));
      } catch (error) {
        setDetailsError(error instanceof Error ? error.message : 'Failed to load hero subtype');
      } finally {
  ...
  const validateForm = (form: FormState): string | null => {
    ...
    if (form.description.ru.trim() || form.description.en.trim()) {
      const descriptionError = validateLocalizedTextPair(
        form.description,
        t.descriptionRu,
        t.descriptionEn,
      );
    ...
    if (!form.groupId) return t.groupRequired;
    return null;
  };

  const buildPayload = (form: FormState): CreateHeroTagRequest => ({
  ...
  const resetEditForm = (item: HeroTagItem) => {
    setEditForm({
      name: { ...item.name },
  ...
  const handleLoadMore = async () => {
    ...
    setLoadingMore(true);
    try {
      const response = await apiJson<CatalogResponseDto<HeroTagResponseDto>>(
        `${CATALOG_API}?page=${catalogPage.page + 1}&size=${catalogPage.size}${
          searchQuery.trim() ? `&search=${encodeURIComponent(searchQuery.trim())}` : ''
        }`,
      );
      setItems((prev) => [...prev, ...response.items.map(mapHeroTagDto)]);
      setCatalogPage(response);
    } catch (error) {
      setListError(error instanceof Error ? error.message : 'Failed to load more hero subtypes');
    } finally {
  ...
  const handleCreate = async () => {
    ...
    setSubmitError(null);
    try {
      const created = await apiPostJson<CreateHeroTagRequest, HeroTagResponseDto>(
        API,
        buildPayload(createForm),
      );
      const mapped = mapHeroTagDto(created);
      ...
      setSubmitError(error instanceof Error ? error.message : 'Failed to create hero subtype');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const handleUpdate = async () => {
    ...
    setSubmitError(null);
    try {
      const updated = await apiPutJson<UpdateHeroTagRequest, HeroTagResponseDto>(
        `${API}/${editingId}`,
        buildPayload(editForm),
      );
      const mapped = mapHeroTagDto(updated);
      ...
      setSubmitError(error instanceof Error ? error.message : 'Failed to update hero subtype');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const groupOptions = groups.map((group) => ({
    ...
    label: getLocalizedText(group.name, locale),
    secondaryLabel: group.description ? getLocalizedText(group.description, locale) : null,
  }));
          ...
          {loadingDetails ? (
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4">
                ...
                <div className="text-sm text-[var(--foreground)]">
                  {selectedItem.groupName ? getLocalizedText(selectedItem.groupName, locale) : t.noGroup}
                </div>
              </div>
            </div>
          )}
      ...
      >
        <div className="space-y-6">
          ...
          <SearchableSelectField
            ...
            onChange={(value) => setCreateForm((prev) => ({ ...prev, groupId: value }))}
            options={groupOptions}
            placeholder={t.selectGroup}
            searchPlaceholder={t.searchGroup}
            searchAriaLabel={t.searchGroup}
            clearSearchLabel={t.clearGroupSearch}
            noResultsLabel={t.noGroupFound}
          />
      ...
      >
        <div className="space-y-6">
          ...
          <SearchableSelectField
            ...
            onChange={(value) => setEditForm((prev) => ({ ...prev, groupId: value }))}
            options={groupOptions}
            placeholder={t.selectGroup}
            searchPlaceholder={t.searchGroup}
            searchAriaLabel={t.searchGroup}
