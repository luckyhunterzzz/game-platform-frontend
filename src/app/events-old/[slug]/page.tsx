...
export default function EventDetailsPage() {
  ...
  const quickLinks = useMemo<QuickLinkItem[]>(
    () => [
      ...
      { label: messages.home.navEvents, href: '/events-old', imageSrc: '/home-quick-links/event.webp' },
      { label: locale === 'ru' ? '\u0421\u0443\u043D\u0434\u0443\u043A\u0438' : 'Chests', href: '/chests', imageSrc: '/home-quick-links/guides.png' },
      { label: messages.home.navAlliances, href: '/alliance', imageSrc: '/home-quick-links/alliance.webp' },
    ],
    [
      locale,
  ...
  const eventPath = `/events-old/${eventItem.slug}`;
